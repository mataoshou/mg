...
//
//    @org.apache.ibatis.annotations.Insert(value={"${sql}"})
//    @org.apache.ibatis.annotations.SelectKey(before=false,resultType=java.lang.Integer,statement={"call identity()"},keyProperty="id")
//    long insertBySql( @org.apache.ibatis.annotations.Param(value="sql") String sql);
